# How to Create a Simple Calculator Using Python | GUI Tkinter Project - Parvat Computer Tech
...
# Buttons used for calculator

Button(root,text="C",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#3697f5",command=lambda: clear()).place(x=10,y=100)

if value==0:
    Button(root,text="/",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#2a2d36",command=lambda:add("/")).place(x=150,y=100)
else:
...
if value==1:
    Button(root,text="=",width=5,height=3,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#EA950B",command=lambda:calculate()).place(x=430,y=400)
    value==0
